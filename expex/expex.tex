\def\ExPexMessage
   {2015/10/05 v5.0e ExPex linguistics example formatter (JF)}
% -------------------------------------------------------
% jf 2011/12/09  (v4.0a)
...
\ifx\ProvidesFile\@undefined
   ...
   \else
      ...
      \let\it=\itshape
      \let\sc=\normalfont\scshape % Ivan Kapitonov 2017/05/13 for KOMA compatibility
      \let\rm=\normalfont\rmfamily % Ivan Kapitonov 2017/05/13 for KOMA compatibility
      \let\tt=\normalfont\ttfamily % Ivan Kapitonov 2017/05/13 for KOMA compatibility
      \let\pageno=\c@page
% 2013/07/27
...
%%%% TEMP
\def\RR{\writeln{RR after: \noexpand\glft -> \meaning\glft}}
%%%% END TEMP
...
%      \hsize=\ssleftwd
%      \lingset{glwidth=\ssleftwd}
%      \gl@nlevel@below@begin
%}
%\def\gl@nlevel@right@end{\egroup\egroup}
%\def\gl@nlevel@right@ft #1{%
%   \gl@nlevel@right@end
%   \hskip\lingsssep
%   \vtop{%
%      \leftskip=0pt
