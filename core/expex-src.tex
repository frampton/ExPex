...
% jf 2012/12/01 v.4.1
%  1) added auto wrapskip mode to glosses
...
\define@ling@cmdkeys{glhangindent}
\define@ling@cmdkeys{glwidth}
\define@lingincskipkeys{glspace,extraglwrapskip}
\define@lingincskipkeys{aboveglftskip,belowglpreambleskip,glwrapskip}
\define@lingkey{abovemoreglskip}{\lingset{glwrapskip=#1}} % obsolete
\define@boolkey{ling}[ling@]{autoglwrapskip}{}
...
\def\glw@begingl@a{%
   \vtop\bgroup
      ...
      \ifling@autoglwrapskip
         \let\glstrut=\strut
         \epd@glwrapskip=\baselineskip
         \advance\epd@glwrapskip by -\dp\strutbox
         \advance\epd@glwrapskip by -\ht\strutbox
         \advance\epd@glwrapskip by \lingextraglwrapskip
      \else
         \epd@glwrapskip=\lingglwrapskip
      \fi
...
\def\glw@endglA{\lineskip=\epd@glwrapskip
...
%\def\showskips{\writeln{+++++ wrapskip: \lingglwrapskip, extra: \lingextraglwrapskip, dim: \the\epd@glwrapskip\space +++++}}
\resetatcatcode
%! ----- initial settings -----
...
% parameters used in glosses
   glspace=.5em plus.25em minus.16667em,
...
\def\gloldstyle{%
   \lingset{abovemoreglskip=1ex,autoglwrapskip=false,
...
%   \closein\expexsupp \input expex-add \fi
