\def\ExPexMessage{2011/12/09 v4.0b ExPex linguistics example formatter (JF)}
% -------------------------------------------------------
...
\define@lingincskipkeys{glspace}
...
\def\normalglwrapskips{%
   \epd@a=\baselineskip
   \advance\epd@a by -\dp\strutbox
   \advance\epd@a by -\ht\strutbox
   \lingset{glstruts=true,glwrapskip=\epd@a}%
   \ignorespaces
}
...
\def\glw@endglA{\lineskip=\lingglwrapskip
