\def\ExPexMessage{2013/01/13 v4.1a ExPex linguistics example formatter (JF)}
% -------------------------------------------------------
% jf 2011/12/09  (v4.0a)
...
% 2/10/2013 control over whether there is a break before \ex
\define@boolkey{ling}[ling@]{nobreakaboveex}[true]{}
\lingset{nobreakaboveex=false}
\def\ex@setup{%             also used by \pex
   \extraaboveexskip=\baselineskip
   ...
   \ifx\@optionaltag\empty
      ...
      \fi
% 2/10/2013 added nobreak option (see above parameter)
   \ifling@nobreakaboveex \par\nobreak \else \exbreak \fi
   \if@tilde \else \vskip\lingaboveexskip\fi
% 3/13/2013 added next two lines to keep spacing with double spacing etc.
   \advance\extraaboveexskip by -\baselineskip
   \vskip\extraaboveexskip
   \parindent=0pt
}
% 3/13/2013 next line
\newdimen\extraaboveexskip
