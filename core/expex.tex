...
%% epx@Mlevels is the list of M-levels that have been defined
\def\epx@letlevels{%
   \expandafter\XKV@for@n\expandafter{\epx@Mlevels}\levelname
   {\edef\temp{\noexpand\let
...
\newdimen\epx@pshapeindent
\newdimen\epx@pshapelinewd
\def\epx@parshapetarget{}
\def\epx@mkshapeaux{%
   \edef\epx@parshapetarget
      {\epx@parshapetarget\space
         \the\epx@pshapeindent\space\the\epx@pshapelinewd}%
   \advance\epx@pshapeindent by \ling@glhangindent
   \advance\epx@pshapelinewd by -\ling@glhangindent
}
\def\epx@mkshapeauxaux{\epx@mkshapeaux\epx@mkshapeaux\epx@mkshapeaux}
\def\epx@makeshape{%
   \epx@pshapeindent=0pt
   \epx@pshapelinewd=\hsize
   \epx@mkshapeaux\epx@mkshapeaux\epx@mkshapeaux\epx@mkshapeaux
}
\def\epx@makeshape{%
   \epx@pshapeindent=0pt
   \epx@pshapelinewd=\hsize
   \epx@mkshapeauxaux\epx@mkshapeauxaux\epx@mkshapeauxaux
}
...
\def\glmw@mergerow@a{%
   ...
   \ifx\tempb\Linebreak
      ...
      \else\ifx\tempb\Lbrack
         \expandafter\gappend\Lbrack\to\clist
      \else\ifx\tempb\Rbrack
         \expandafter\gappend\Rbrack\to\clist
      \else
         \lop\alist\to\tempa
...
\def\glmw@gla@d #1 {%
   ...
   \ifx\tempa\Linebreak
      ...
      \else\ifx\tempa\Lbrack
         \expandafter\gappend\Lbrack\to\mainlist
      \else\ifx\tempa\Rbrack
         \expandafter\gappend\Rbrack\to\mainlist
      \else
