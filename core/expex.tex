...
%}
\def\ep@setdimpreambleleft{%
   \epd@preambleleft=\ling@preambleoffset
...
\definelabeltype{alpha}{labelgen=char,pexcnt=`a,labelformat=A.,
   fullrefformat=XA,labelalign=left,samplelabel=b.}
\definelabeltype{caps}{labelgen=char,pexcnt=`A,labelformat=A.,
   fullrefformat=XA,labelalign=left,samplelabel=A.}
\definelabeltype{numeric}{labelgen=number,pexcnt=1,labelformat=A.,
   fullrefformat=X.A,labelalign=right,samplelabel=2.}
%%%%%
%\lingset{%
%   labeltype=alpha,
%   everylabel=,
