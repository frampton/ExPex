...
\define@choicekey{ling}{glstyle}[\ling@glstyle\gl@stylenum]%
   {wrap,3level,oldstyle,multilevel,multiwrap}{%
      \ifcase\gl@stylenum
            \let\gl@beginglstyle\glw@begingl@aa
            \let\endgl\glw@endgl
            \glw@assignlevels
            \let\glft=\glw@glft
         \or
            \let\gl@beginglstyle=\begingl@T
            \let\endgl\endgl@T
            \glw@assignlevels
            \let\glft=\glw@glft
         \or
...
%% \glw@levels is the list of mw-levels that have been defined
...
\def\@begingl{\ling@usearg\gl@beginglstyle}
...
\def\glw@mklevel#1{%
   \expandafter\ifx\csname glw@gl#1\endcsname\relax
      ...
      \lingset{everygl#1=,abovegl#1skip=0pt}
      \expandafter\def\csname glw@gl#1\endcsname{\@glmw{#1}}%
   \else
...
\def\definemwlevels#1{\XKV@for@n{#1}\thislevel
   {%
   \expandafter\glw@mklevel\expandafter{\thislevel}}%
...
\def\@glmw#1{%
   ...
   \glw@maxdp=0pt
   \def\gl@linelabel{#1}%
   \@getoptionalarg\@glw@a
}
\def\@glw@a #1// {\bgroup
   \ling@usearg
   \@glw@b #1 \@nil }
\def\@glw@b{\@ifnextchar\@nil\@glw@c\@glw@d}
\def\@glw@c#1{\glw@updateauxlists \glw@mergerow\worklist\to\mainlist\egroup}
\def\@glw@d #1 {%
   \def\tempa{#1}%
   \edef\temp{%
...
\def\glw@endgl@a{\lineskip=\ling@abovemoreglskip\glw@print \par}
%%
%\def\glw@begingl{\bgroup\@getoptionalarg\glw@begingl@a}
%\def\glw@begingl@a{\ling@usearg\glw@begingl@aa}
\def\glw@begingl@aa{%
   \parindent=0pt
   \W@prefixboxfalse
   \@ifnextchar\gla\glw@begingl@@\glw@begingl@prefix
}
%\def\begingl{\bgroup\@getoptionalarg\@begingl}
%\def\@begingl{\ling@usearg\gl@beginglstyle}
\def\glw@glft#1//{%
