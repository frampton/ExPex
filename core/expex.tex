...
\def\glmw@begingl{\@getoptionalarg\glmw@begingl@a}
\def\glmw@begingl@a{%
   \bgroup\ling@usearg
   \ling@everygl
   \let\mainlist=\empty \let\aboveskiplist=\empty \let\strutlist=\empty
}
\def\glmw@endgl{\glmw@endgl@a\egroup}
\def\glmw@endgl@a{\lineskip=\ling@abovemoreglskip\glmw@print \par}
\def\glmw@glft{\glmw@endgl \@getoptionalarg
   \glmw@glft@a}
\def\glmw@glft@a{%
   \bgroup
   \let\endgl=\egroup
   \ling@usearg \vskip\ling@aboveglftskip \ling@everyglft
