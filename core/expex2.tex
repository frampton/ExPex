...
\define@choicekey{ling}{exnotype}[\ling@exnotype\@N]%
   {arabic,roman}{%
      \ifcase\@N
            \let\exnoprint=\arabicexnoprint
         \or
            \let\exnoprint=\romanexnoprint
         \fi
}
\def\arabicexnoprint{\exnoformat{\the\excnt}}
\def\romanexnoprint{\exnoformat{\romannumeral\the\excnt}}
\lingset{exnotype=arabic}
\def\romanexnumbers{\let\exnoprint=\romanexnoprint}
%\def\specialexnoprint{(\lingspecialexno)}
\def\specialexnoprint{\exnoformat{\lingspecialexno}}  % unformatted
...
\lingset{sampleexno=}
\define@linginckey\skip{}{}{belowpreambleskip}
\define@linginckey\skip{}{}{interpartskip}
...
\define@lingkey{exnoformat}{\epx@mkexnoformater #1\@nil}
\def\epx@mkexnoformater #1X#2\@nil{%
   \def\exnoformat##1{#1{##1}#2}}
...
%         \fi
%}
% BELOW RENDER glstyle IMPOTENT
% it could be brought back to life by code along the lines of the code above
\define@key{ling}{glstyle}{%    any setting of glstyle gives the wrap style
   \let\gl@beginglstyle\glw@begingl
   \let\endgl\glw@endgl
   \glw@assignlevels
   \let\glft=\glw@glft
...
\def\glw@endglA{\lineskip=\lingabovemoreglskip
...
%         \ifdim\lingaboveglftskip=0pt
%            \else \noalign{\vskip\lingaboveglftskip}\fi
...
%\def\glft@M@a #1//{%
%   \if@tilde \else \vskip\lingaboveglftskip \fi \egroup
...
%}
%\def\moregl{%
%   \egroup\egroup \vskip\lingabovemoreglskip
%   \vtop\bgroup
