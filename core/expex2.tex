...
\def\arabicexnoprint{(\the\excnt)}
\def\romanexnoprint{(\romannumeral\the\excnt)}
...
\define@linginckey\dimen{}{}{minexnolabelsep}
\define@lingkey{sampleexno}{%
   \setbox0=\hbox{#1}%
   \dimen1=\wd0
   \advance\dimen1 by \lingminexnolabelsep
   \lingset{labeloffset=\the\dimen1}%
   \ignorespaces
}
