...
\define@ling@cmdkeys{everygl,everyglpreamble,everygl,everyglilg,everyglft,
...
\def\glw@ilg@start{%
   ...
   \ifling@autoglskip
      ...
      \ifdim\epd@gllineskip<0pt \epd@gllineskip=0pt \fi
   \else
      \epd@gllineskip=\lingextraglskip
   \fi
...
\long\def\glw@glft@a #1//{%
   ...
   \glw@printilg
   \par
%   \ifdim\lineskip=0pt \global\let\@oneshotlineskip=\relax \else
%      \xdef\@oneshotlineskip{\vskip\the\lineskip}\fi
   \egroup
%   \@oneshotlineskip
   \ifx\glstrut\strut
      \ifdim\gl@maxdplast>\dp\strutbox \prevdepth=\gl@maxdplast \fi
   ...
   \vskip\lingaboveglftskip
   \ling@everyglft
   \def\endgl{\egroup\egroup}%
   \strut #1\par
}
\def\glw@endgl{\glw@printilgsetup \glw@printilg \glw@closegroups}
...
%   \edef\gl@lineskipsave{\noexpand\lineskip=\the\lineskip}%
   ...
   \ifling@autoglskip
      ...
      \advance\lineskip by -\dp\strutbox
      \advance\lineskip by -\ht\strutbox
      \advance\lineskip by \lingextraglskip
      \writeln{lineskip: \the\lineskip}
      \ifdim\lineskip>0pt \writeln{!!!! YES}
            \xdef\@ilgborderadjustment{\vskip\the\lineskip}%
         \else \writeln{!!!! NO}
            \lineskip=0pt
            \let\@ilgborderadjustment=\relax
         \fi
      \@ilgborderadjustment
%      \epd@gllineskip=\baselineskip
%      \advance\epd@gllineskip by -\dp\strutbox
...
\def\glw@printilg{%
   \ifx\mainlist\empty \else \glw@printilg@i \par \fi
}
\def\glw@printilg@i{%
...
%         \vskip\epd@gllineskip
      ...
      \repeat
   \writeln{++++\meaning\@ilgborderadjustment}
   \@ilgborderadjustment  % ?????
}
...
%\lingset{glwordalign=left}
%%%%%%%%%%%%%%%%%%%% nlevel style glosses %%%%%%%%%%%%%%%%%%%%
% prelims
\def\varstrut#1{\varstrut@i #1 0pt \@nil}
\def\varstrut@i #1 #2 #3\@nil{%
   \ep@dima=\ht\strutbox \advance\ep@dima by #1
   \ep@dimb=\dp\strutbox \advance\ep@dimb by #2
   \vrule height\ep@dima depth\ep@dimb width0pt
}
\define@lingcmdkeys{extraglstrut}
\lingset{extraglstrut=}
\def\ep@setglstrut{%
   \ifling@glstruts
      \ifx\lingextraglstrut\empty \setbox\glstrutbox=\copy\strutbox
      \else \expandafter\ep@setglstrut@i\lingextraglstrut\@nil \fi
   \else
      \setbox\glstrutbox=\hbox{}%
   \fi
}
\def\ep@setglstrut@i #1 #2\@nil{%
   \ep@dima=\ht\strutbox \advance\ep@dima by #1
   \ep@dimb=\dp\strutbox \advance\ep@dimb by #2
   \setbox\glstrutbox=\hbox{\vrule height\ep@dima depth\ep@dimb width0pt}%
}
% end prelims
...
\def\gln@Cc{%
   ...
   \advance\lineskip by -\ht\strutbox
   \advance\lineskip by \lingextraglskip
   \ifdim\lineskip<0pt \lineskip=0pt \fi
%   \lineskip=\lingextraglskip
   \rightskip=\ling@glrightskip
   \ifcase\ep@glhangstyle
      \or
...
\def\gln@preamble #1\endpreamble{%
   {\ling@everyglpreamble #1\strut \vskip\lingbelowglpreambleskip}%
%# body grouped so that everyglpreamble is scoped
   \gln@Cc}
\def\gln@ft{\vskip\lingaboveglftskip\strut
   \gl@restoreouterbaselineskip \ling@everyglft}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\def\gln@di#1#2/{\gl@append #2\to\@currentitem \gln@e}
\def\gln@dii#1/{\gl@append #1\to\@currentitem \gln@e}
...
\def\gln@endgl{\par\egroup\egroup\egroup}
%\def\gln@ft{\vskip\lingaboveglftskip\strut \ling@everyglft}
\define@lingkey{glneveryline}{\setlist\gln@everyline{#1}}
\define@lingkey{glnabovelineextraskip}{\setlist\gln@aboveskiplist{#1}}
...
%%%%% if the following works correctly, go back and deleter the stuff
%above, back to the ----- cascading intro line
...
%\definelingstyle{glossfactorysettings}{%
\lingset{%
