...
%         \ifx\alist\empty \gl@loopmorefalse \fi
      \ifgl@loopmore
...
%      \else \@itemtype=0
%      \def\@mainlistappend{\\{#1#2}}%
%         \fi\fi\fi\fi
%   \else
%      \glw@wordtrue
%      \ifx#1\nogloss\@itemtype=5 \def\@mainlistappend{\\{#2}}%
%      \else \@itemtype=0
%      \def\@mainlistappend{\\{#1#2}}\fi
%   \fi
%}
%\def\glw@gla@d #1 {%
%   \def\temp{#1}%
...
%      \gl@eappend\@mainlistappend \to\mainlist
%   \fi
%   \ifglw@word
...
\def\glw@gla@d #1 {%
   ...
   \else
      \@setitemtype #1\@nil
      \ifnum\@itemtype=0 \gl@append \\{#1}\to\mainlist
...
\def\glw@print{%
   ...
   \loop\ifgl@loopmore
      ...
      \gl@lop\itemtypelist\to\tempb\relax
      \ifcase\tempb
         \glw@print@i
      \or
...
%   \let#2\empty \else\expandafter\gl@lopoffTL#1\gl@lopoffTL#1#2\fi}
   #2={}\else\expandafter\gl@lopoffTL#1\gl@lopoffTL#1#2\fi}
...
\def\varstrut@i #1 #2 #3\@nil{%
   \epd@a=\ht\strutbox \advance\epd@a by #1
   \epd@b=\dp\strutbox \advance\epd@b by #2
   \vrule height\epd@a depth\epd@b width0pt
}
\newbox\glstrutbox
...
\def\ep@setglstrut{%
   ...
   \else \expandafter\ep@setglstrut@i\lingextraglstrut\@nil
   \fi
}
\def\ep@setglstrut@i #1 #2\@nil{%
   \epd@a=\ht\strutbox \advance\epd@a by #1
   \epd@b=\dp\strutbox \advance\epd@b by #2
   \setbox\glstrutbox=\hbox{\vrule height\epd@a depth\epd@b width0pt}%
}
