...
\def\glw@gla@c#1{\glw@updateauxlistsA \egroup \ignorespaces}
\newif\ifglw@word
\def\glw@gla@d #1 {\writeln{#1++++++++++}%
   \def\glw@linelabel{a}%
   \glw@onetokenfalse
   ...
   \ifx\tempa\Linebreak
      ...
      \else
         \edef\temp{\noexpand\\{\epx@expandonce\ling@everygla
            \epx@expandonce\tempb}}%
...
\def\glw@updateauxlistsA{%
   \ifdim\ling@aboveglaskip=0pt \let\temp=\empty
      \else
...
\def\glw@glx@d #1 {%
   ...
   \gltoks@a=\expandafter{\@every}%
   \gltoks@b={#1}%
   \edef\tempB{\the\gltoks@a \the\gltoks@b}%
   \setbox0=\hbox{\tempB}%
   \ifdim\glw@maxht<\ht0 \glw@maxht=\ht0 \fi
   \ifdim\glw@maxdp<\dp0 \glw@maxdp=\dp0 \fi
   \expandafter\glw@append\tempB\to\worklist
   \glw@glx@b
}
\defineglwlevels{b}
...
\def\glw@begingl{%
   \parindent=0pt
   \let\glw@preamble\empty
   \@ifnextchar\gla\glw@begingl@a\glw@begingl@b
}
\def\glw@begingl@a{%
   \vtop\bgroup
      \ling@usearg
      ...
      \ling@everygl
      \leftskip=0pt
      \ifx\glw@preamble\empty \else
         {\ling@everyglpreamble\glw@preamble\vskip\ling@belowglpreambleskip}\fi
...
\def\glw@begingl@b #1\gla{%
   \ifling@noglpreamble #1\else \def\glw@preamble{#1}\fi
   \glw@begingl@a
   \gla
}
\def\glw@glft#1//{%
...
\def\glw@endglA{\lineskip=\ling@abovemoreglskip \glw@print
\par}
...
\def\rightcomment#1{\rlap{%
   \hbox to\hsize{\hfil #1\hskip\leftskip}}\ignorespaces}
