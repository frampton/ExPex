...
\usepackage{expex,ep-conversation}
...
\glb {\sc neg}-straight-{\sc neg} {\sc comp} {\sc 2-npst-sg}-make
...
\glb {\sc neg}-say-{\sc comp} {\sc poss-2sg} earth //
\endgl
\endspeaker
...
\glb {\sc comp} {\sc poss-2sg} earth still {2-npst-sg}-make
