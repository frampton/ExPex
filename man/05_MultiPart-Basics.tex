...
\idx{|labeloffset|}\public & \inc dimension& |1em|\cr
\idx{|labelwidth|}\public & \inc dimension& |.72em|\cr
\idx{|preambleoffset|}\public & \inc dimension& |1em|\cr
\idx{|interpartskip|}\public & \inc skip&
   |1ex plus .2ex minus .2ex|\cr
\idx{|belowpreambleskip|}\public & \inc skip&
   |1ex plus .2ex minus .2ex|\cr
%\idx{|nopreamble|}& boolean& (not relevant)\quad [{\it Default\/}: |true|]\cr
...
The horizontal dimensions are parametrized as pictured below,
assuming the default settings of the parameters |labelanchor| and
