...
& \idx{|belowglpreambleskip|\user}& (!)dimension& |1ex|\cr
& \idx{|aboveglbskip|\user}& (!)dimension& |0pt|\cr
& \idx{|aboveglcskip|\user}& (!)dimension& |0pt|\cr
& \idx{|aboveglftskip|\user}& (!)dimension& |1ex|\cr
\endparinventory
\vskip-1ex
\hrule
\medskip
...
items, all consisting of a single character; |+|, |@|, |[|, or
|]|.
...
\parameters
\idx{|glbrackbracksep|\user}& dimension& \hfil |.05em|\cr
\idx{|glbrackwordsep|\user}& dimension& \hfil |.1em|\cr
\endinventory
%
