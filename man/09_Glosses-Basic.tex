...
\xe
|endcodedisplay
The latter is perhaps conceptually neater, in that the parameter
changes have scope only where the changes are relevant.  But the
former has the big advantage that it is much easier to see what the
