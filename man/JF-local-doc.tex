...
%   belowfdskip=2ex plus .3ex minus .1ex,
   abovefdskip=3ex plus .5ex,
   belowfdskip=3ex plus .3ex minus .1ex,
...
\def\boxglwords{\let\glw@printglword=\glw@printglwordboxed}
\def\glw@printglwordboxed{%
   \begingroup
   \gltoks@sofar={}%
   \gl@loopmoretrue
   \loop\ifgl@loopmore
      ...
      \repeat
   \psframebox[framesep=-.2pt,boxsep=false,linewidth=.4pt]{\vtop{%
%      \gl@lineskipsave
      \ling@everyglword
...
\def\textsc#1{{\sc #1}}
%
%\def\parvalue#1{{\tt \char"7C \kern-.6pt #1\kern-.6pt \char"7C }}
\def\parvalue#1{Val(|#1|)}
