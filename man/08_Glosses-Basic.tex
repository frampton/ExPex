...
%\pex
%\a
%\begingl[glbrackwordsep=.2em,glbrackbracksep=.1em]
%\gla a [ [ b ] [ c ] ]//
%\glb x y z//
%\endgl
%\a
%\begingl[glbrackwordsep=0em,glbrackbracksep=0 em]
%\gla a [ [ b ] [ c ] ]//
%\glb x y z//
%\endgl
%\xe
...
& \idx{|everyglpreamble|}& token list& \it empty\cr
& \idx{|everygla|}& token list& |\it|\cr
& \idx{|everyglb|}& token list& \it empty\cr
& \idx{|everyglc|}& token list& \it empty\cr
...
\codedisplay
\definelingstyle{Potawatamy}{glspace=2em,everygla=,everyglb=\tenpoint,
   aboveglbskip=-.4ex,everyglft=\it,aboveglftskip=0pt}
|endcodedisplay
...
the period on the gla-line.  The examples are adapted from {\it The
Design of Agreement\/} by Sandra Chung.  See (59a) on page 237 and
(82a) on page 247.
