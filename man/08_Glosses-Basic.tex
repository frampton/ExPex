...
(\blastx).  User defined lines are also allowed, see Section ().
...
\noindent Macros:\quad \idx{|\rightcite|}, \idx{|\pushrightcite|}
\smallskip
...
\framedisplay
\pex[glstyle=wrap,everygla=,everyglb=,everyglc=,
   aboveglaskip=0pt,aboveglbskip=0pt,aboveglftskip=1ex,glwidth=2.5in]
\a \begingl \writeln{\the\hsize>>>>>>>>>}
\rightcite{(Hockett 1948, p. 143)}
\gla k- wapm -a -s'i -m -wapunin -uk //
