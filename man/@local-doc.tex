...
% formatting
\def\endinventory{\egroup\par\bigskip\endgroup\noindent}
\def\inventory{%
   \begingroup \openup1pt \leftskip=0pt \parindent=0pt
   \halign\bgroup
      ##\hfil& \enspace\tt ##\hfil&& \qquad ##\hfil\cr
}
...
\def\framedisplay@aa{\bgroup
   \Ling@usearg
   \setbox\@framedisplaybox=\vbox\bgroup\vskip-\lingaboveexskip
}
\def\endframedisplay{%
