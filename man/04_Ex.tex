...
\noindent
\begininventory
\omit Macros:\quad \idx{|\ex|}|~[]|, \idx{|\xe|}\hidewidth\cr
\omit Counter:\quad \idx{|\excnt|}\cr
\parameters\cr
\idx{|numoffset|}\public & \inc dimension& \textdim{0 pt}\cr
\idx{|textoffset|}\public& \inc dimension& \textdim{1 em}\cr
\idx{|aboveexskip|}\public& \inc skip&
   \textdim{2.7 ex} plus \textdim{.4 ex} minus \textdim{.4 ex}\cr
...
& \idx{|exnoformat|}& token list of the form \dots |X|\dots& |(X)|\cr
\endparinventory
