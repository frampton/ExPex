...
%\def\glw@endgl{\glw@printilgsetup \glw@printilg@a \glw@closegroups}
\def\glw@endgl{\glw@printilg \glw@closegroups}
%\def\glw@endgl{%
%   \if@glft
%      \egroup\egroup
%   \else
...
%\def\glw@printilg@a{\bgroup\ifx\mainlist\egroup \else \glw@printilg@b \par \fi }
\def\glw@printilg@b{%
...
%      \writeln{currentitemtype: \@currentitemtype}
...
\def\gln@preamble #1\endpreamble{%
   {\ling@everyglpreamble #1\strut \vskip\lingbelowglpreambleskip
      \vskip\lingextraglskip \egroup\bgroup }%
%# body grouped so that everyglpreamble is scoped
   \gln@Cc}
\def\gln@ft{\vskip\lingaboveglftskip \vskip\lingextraglskip
   \egroup\bgroup
%   \gl@restoreouterbaselineskip
   \nointerlineskip
   \strut
   \ling@everyglft}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\define@lingkey{aboveglnlineskip}{\setlist\gln@aboveskiplist{#1}}
\def\setlist#1#2{\def#1{}\XKV@for@n{#2}\@this{\gl@eappend\@this\to#1}}
\lingset{glneveryline={},aboveglnlineskip={}}
%%%%%%%%%%%%%%%% end nlevel %%%%%%%%%%%%%%%%%%%%
