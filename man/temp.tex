...
\lingset{everytrailingcitation=\footnotesize}

\hsize=3in

\ex
\begingl[everygl={\rightskip=-1in}]
...
\def\\#1#2{\pnode(0,#2){#1}}
\psset{unit=.4,nodesep=.5}

B: A\\{A}{2}\ \\{B}{2}driv\\{C}{4}ing instruct\\{D}{1.5}or\\{E}{2}!?

\SpecialCoor
\pscurve (A)(B)([angle=225]C)(C)([angle=335]C)(D)(E)
