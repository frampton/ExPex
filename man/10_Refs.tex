...
and before before last example numbers.  The example number
counter is incremented early in the expansion of |\ex| and |\pex|,
so these macros can be used inside an example, with ``last
example'' taking on the meaning of ``current example'' and the
others similarly interpreted.
