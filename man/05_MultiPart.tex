...
|numoffset| and |textoffset|, which are relevant to examples in
general, not just multipart examples.
...
\subsection  Anchoring the labels
...
\medskip
\noindent
|\deflabeltype{greekmath}{labelgen=char,pexcnt=11,everylabel=\mit,|\par
\noindent
|   labelformat=A.}|
\medskip
