...
\ifx\ProvidesFile\undefined
   ...
   \else
      ...
      \begin{document}
   \fi
\def\SC #1{{\footnotesize\uppercase{#1}}}
%--------------------------------------------------------------------
\hrule\medskip
...
gaps.  Here we are concerned with example formating, not with the
interesting syntax.
...
Multipart examples are equally straighforward.
...
\begingl
\gla wiye kepi e- @ ca//
\glb two whitemen 1\SC{p}:3\SC{d}- found//
\endgl
\xe
\endgroup
\bigskip
