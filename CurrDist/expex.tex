...
\ifx\ProvidesFile\@undefined
   \message{2011/11/28 (preliminary) ExPex linguistics
      example formatter (JF)}
\else
   \ProvidesFile{expex.tex}[2011/11/28 (preliminary)
...
\define@key{ling}{exno}{%
   ...
   \def\lingspecialexno{\unhcopy\exnobox}%
}
...
\define@lingincdimenkeys{glspace}
\define@lingincskipkeys{aboveglftskip,abovemoreglskip,belowglpreambleskip}
